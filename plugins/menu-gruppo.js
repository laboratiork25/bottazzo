 ...
 * ║  ► Data: 2025                                                               ║
 * ║                                                                              ║
 * ║  Questo modulo gestisce il menu gruppo con supporto                        ║
    ...
    await conn.sendMessage(
        message.chat,
        {
            ...
            templateButtons: [
                ...
                { index: 2, quickReplyButton: { displayText: global.t('adminMenuButton', userId, groupId) || "🛡️ Menu Admin", id: `${usedPrefix}menuadmin` } },
                { index: 3, quickReplyButton: { displayText: global.t('ownerMenuButton', userId, groupId) || "👑 Menu Owner", id: `${usedPrefix}menuowner` } },
                { index: 4, quickReplyButton: { displayText: global.t('securityMenuButton', userId, groupId) || "🚨 Menu Sicurezza", id: `${usedPrefix}menusicurezza` } },
...
┃◈┃• 💳 *.donauc*   
┃◈┃• 🛒 *.compra* (${global.t('buyUCCommand', userId, groupId) || 'acquista UC'})  
...
┃◈┃• 💍 *.sposami* (${global.t('proposalCommand', userId, groupId) || 'proposta'})  
...
┃◈┃• 🤫 *.segreto* @${global.t('userCommand', userId, groupId) || 'utente'}  
