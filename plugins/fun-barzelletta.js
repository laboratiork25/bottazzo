...
var handler = async (m, { conn, text }) => {
    ...
    const emoji2 = global.t('jokeEmoji', userId, groupId) || "😂";
    
    conn.reply(m.chat, global.t('jokeSearching', userId, groupId) || `${emoji2} Cerco una barzelletta, attendi un momento...`, m)

    conn.reply(m.chat, global.t('jokeFormat', userId, groupId, {
        joke: pickRandom(global.barzelletta)
