...
// Definisci mid inline
const mid = {
  smsApk: "Specifica il nome dell'applicazione.",
  smsApk2: "Ultimo aggiornamento",
  smsApk3: "Scarica ora",
  smsApk4: "Il file è troppo grande per essere scaricato.",
  smsYT11: "Dimensione:",
  name: "Applicazione",
...
// Definisci eg inline
const eg = "📥 Informazioni sull'applicazione:\n";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        conn.sendButton(
          m.chat,
          `Si è verificato un errore temporaneo, premi il pulsante per riprovare...`,
          wm,
          null,
          [['Riprova', `.apk2 ${text}`]],
          null,
