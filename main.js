/**
 * ╔══════════════════════════════════════════════════════════════════════════════╗
 * ║                         CHATUNITY BOT - MAIN CORE                           ║
 * ║                                                                              ║
 * ║  ► Versione: 7.0 Beta                                                       ║
 * ║  ► Sviluppatore: Army                                                       ║
 * ║  ► Update: Self Mode Fix & Enhanced Button Support                          ║
 * ║  ► Data: 2025                                                               ║
 * ║                                                                              ║
 * ║  Core principale del bot con sistema di gestione plugin avanzato,          ║
 * ║  supporto multilingue e sistema di bottoni interattivi.                    ║
 * ╚══════════════════════════════════════════════════════════════════════════════╝
 */
...
global.opts['self'] = false; // Ensure bot responds to its own messages for button clicks
...
const connectionOptions = {
  ...
  markOnlineOnConnect: false, // reduce presence traffic on connect
  generateHighQualityLinkPreview: false, // faster, lighter previews
  syncFullHistory: false,  // do not load entire history on startup
...
global.reloadHandler = async function (restatConn) {
  ...
  if (global.languageManager) {
    global.languageManager.loadFromDatabase()
  }
